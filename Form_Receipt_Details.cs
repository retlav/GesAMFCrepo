...
namespace GesAMFC
{
    ...
    public partial class Form_Receipt_Details : DevExpress.XtraEditors.XtraForm
    {
        ...
        //// <versions>08-12-2017(GesAMFC-v0.0.5.2)</versions>
        private void Form_Receipt_Details_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        /// <versions>08-12-2017(GesAMFC-v0.0.5.2)</versions>
        private void Form_Receipt_Details_FormClosing(object sender, System.Windows.Forms.FormClosingEventArgs e)
        {
            try
            {
        ...
        private void Button_OK_Click(object sender, EventArgs e)
        {
            try
            {
                if (Program.IsValidCurrencyEuroValue(this.TextEdit_PayValue.Text.Trim()))
                {
                    ...
                    this.SelectedDescription = this.TextEdit_Description.Text.Trim();
                }
            }
            catch (Exception ex)
            {
