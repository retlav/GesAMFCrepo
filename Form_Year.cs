...
namespace GesAMFC
{
    ...
    public partial class Form_Year : DevExpress.XtraEditors.XtraForm
    {
        ...
        /// <versions>01-12-2017(GesAMFC-v0.0.4.41)</versions>
        private void Form_Year_Load(object sender, EventArgs e)
        {
            try
            {
                SetYearComboList();
        ...
        /// <versions>01-12-2017(GesAMFC-v0.0.4.41)</versions>
        private void Form_Year_FormClosing(object sender, System.Windows.Forms.FormClosingEventArgs e)
        {
            try
            {
        ...
        {
            if (ListYears.ValidYearItem(this.YearSelected))
